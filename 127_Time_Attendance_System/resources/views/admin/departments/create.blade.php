...
<div id="content" class="content departments">
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Departments <small>Create new Department</small></h1>
    <!-- end page-header -->
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Create new Department</h4>
                </div>
                <div class="panel-body">
                    <form action="#" method="POST" name="" class="form-horizontal form_registration">
                        <div id="">
                            ...
                            <fieldset>
                                <legend class="pull-left width-full">Create new Department</legend>
                                <!-- begin row -->
                                <div class="row">
                                    {{ csrf_field() }}
                            ...
                            <button type="button" class="btn btn-primary center-block btn_create"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span> Create New Department </button>
                            <!-- end wizard step-1 -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Department Create</h4>
                                        </div>
                                        <div class="modal-body">
                                            <div class="alert alert-success m-b-0">
                                                <h4><i class="fa fa-info-circle"></i> Successfully Department Created</h4>
                                                <p>You can update / delete/ / view Department information </p>
                                            </div>
                                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $(".departments").on('click','.btn_create',function()
        {
            ...
            request.method   = "POST"       	              ;
            request.route    = 'admin/departments/create'     ;
            request.action   = ''          	                  ;
