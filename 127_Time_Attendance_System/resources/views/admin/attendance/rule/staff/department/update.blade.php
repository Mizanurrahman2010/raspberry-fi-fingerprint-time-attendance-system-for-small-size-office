                ...
                <div class="panel-body">
                    <form action="#" method="POST" name="" class="form-horizontal">
                        <div id="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group bootstrap-timepicker timepicker">
                                                <input id="timepicker_duty_on_time" type="text" value="{{ date('h:i A', strtotime($rule->duty_on_time)) }}" class="form-control input-small">
                                        ...
                                        <div class="col-md-6">
                                            <div class="btn-group" role="group" aria-label="...">
                                                <?php
                                                    ...
                                                    $early_leave_duration_hour   = $early_leave_duration[0];
                                                    $early_leave_duration_minute = $early_leave_duration[1];
                                                ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="btn-group" role="group" aria-label="...">
                                                <?php
                                                    ...
                                                    $early_come_duration_hour   = $early_come_duration[0];
                                                    $early_come_duration_minute = $early_come_duration[1];
                                                ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="btn-group" role="group" aria-label="...">
                                                <?php
                                                    ...
                                                    $late_leave_duration_hour   = $late_leave_duration[0];
                                                    $late_leave_duration_minute = $late_leave_duration[1];
                                                ?>
                            ...
                            <button type="button" class="btn btn-primary center-block btn_create">Updated Attendance Rule <span class="glyphicon glyphicon-arrow-down" aria-hidden="true"></span></button>
                            <!-- end wizard step-1 -->
                            <!-- #modal-alert -->
