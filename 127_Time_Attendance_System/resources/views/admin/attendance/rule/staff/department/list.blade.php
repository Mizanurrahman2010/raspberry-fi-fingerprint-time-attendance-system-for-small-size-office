                ...
                <div class="panel-body">
                    <table id="data-table" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            $entry_time_from = date('h:i:s A', strtotime($value->entry_time_from));
                            ...
                            <tr class="odd gradeX">
                                <td>'.$value->name.'</td>
                                <td>'.$entry_time_from .' - '.$entry_time_to.'</td>
                                <td>'.$out_time_from .' - '.$out_time_to.'</td>
                                <td>'.$value->department_name.'</td>
                                <td>'.($value->status ? 'Enable' : 'Disabled').'</td>
                                <td>
                                    <div class="btn-group btn-group">
                                        <a href="'.url("/admin/attendance/rule/staff/department/{$value->id}/view").'" class="btn btn-primary active"><i class="fa fa-cog"></i> View </a>
                                        <a href="'.url("/admin/attendance/rule/staff/department/{$value->id}/update").'" class="btn btn-success"><i class="fa fa-edit"></i> Update </a>
                                    </div>
                                </td>
                            </tr>
                                ';
