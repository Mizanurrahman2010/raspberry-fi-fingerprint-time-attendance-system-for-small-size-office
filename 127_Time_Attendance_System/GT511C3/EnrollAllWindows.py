            ...
            if fps.CaptureFinger(True):
                ...
                if fps.CaptureFinger(True):
                    ...
                    if iret == 0:
                        ...
                        print('ErrorCode: %s' % ErrorFPS+'-'+str(iret)+' Enrolled id = '+str(enrollid))
                else:
...
fps = FPS.FPS_GT511C3(device_name=DEVICE_WINDOWS, baud=9600, timeout=2, is_com=False) #settings for raspberry pi GPIO
fps.Open()
