...
<div id="content" class="content department_list">
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Department <small>Department List</small></h1>
    <!-- end page-header -->
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <div class="btn-group btn-group">
                                        <a href="'.url("/admin/departments/{$value->id}/view").'" class="btn btn-primary active"><i class="fa fa-cog"></i> View </a>
                                        <a href="'.url("/admin/departments/{$value->id}/update").'" class="btn btn-success"><i class="fa fa-edit"></i> Update </a>
