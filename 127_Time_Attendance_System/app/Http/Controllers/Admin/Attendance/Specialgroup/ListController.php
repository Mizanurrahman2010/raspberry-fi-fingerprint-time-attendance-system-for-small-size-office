...
class ListController extends Controller
{
    ...
    */
    ...
    {
        $attendance_specialgroups = DB::table('attendance_specialgroups')->get();

        return view('admin.attendance.specialgroup.list', ['attendance_specialgroups' => $attendance_specialgroups]);
    }
