...
<div id="content" class="content  attendance_rule_staff_department">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="active">Attendance Rule Update</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Attendance Rule <small> Update Staff Attendance Rule</small></h1>
    <!-- end page-header -->
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Attendance Rule Update</h4>
                </div>
        ...
        $(".attendance_rule_staff_department").on('click','.btn_create',function()
        {
            ...
            for (i=0; i < days_l.length; i++)
            {
                ...
                days[i] = {
                    ...
                    weekend         : ($("input[name='day[]']:eq("+i+")").prop( "checked" ))? 0:1,
