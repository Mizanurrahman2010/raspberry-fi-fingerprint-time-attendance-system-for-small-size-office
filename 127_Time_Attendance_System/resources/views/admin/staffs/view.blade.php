            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-footer">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="{{ url("/admin/staffs/profile/$staff->id/update") }}" class="btn btn-primary"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span> Update </a>
                            <button type="button" class="btn btn-danger btn_delete" data-id="{{$staff->id}}"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span> Delete </button>
                        </div>
                    </div>
                ...
                <div class="panel-body" style="position: relative;">
                    ...
                    <form action="#" method="POST" name="" class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="fps_id" value="{{$staff->fps_id}}" required autofocus>
                            </div>
                        </div>
                    </form>
                </div>
